...
import { useStoreActions } from "../lib/zustand/store";
import { type ShowForm, initialSettings } from "../lib/zustand/store";
...
export const ResumeDropzone = ({
  ...
  const { setResume, setSettings } = useStoreActions();
  ...
  const onImportClick = async () => {
    ...
    // Note: We'll use Zustand's built-in persistence instead of manual localStorage
